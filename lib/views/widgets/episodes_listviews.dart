...
class EpisodesListviews extends StatefulWidget {
  final List<EpisodeModel> episodes;
  final bool loadMore;
  final VoidCallback? onLoadMore;
  const EpisodesListviews(
      {super.key,
  ...
  @override
  State<EpisodesListviews> createState() => _EpisodesListviewsState();
}

class _EpisodesListviewsState extends State<EpisodesListviews> {
